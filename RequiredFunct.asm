...
draw8x8:
	...
	mov.w		R10, R12 ;r10 and r11 contain the x and y coordinate
	mov.w		R11, R13

	call	#setAddress

	mov.w 	#0x0008, R8	;r8 is the column width
...
drawit:
	...
	dec		R8
	jnz		drawit		;until all 8 cells in the width are finished it will stay in the loop

	pop		R13			;fixes stackpointer
	pop		R12
